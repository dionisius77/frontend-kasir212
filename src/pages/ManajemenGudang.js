...
export default function Stock() {
  ...
  const [SelectedKodeBarang, setSelectedKodeBarang,setSelectedKodeTransaksi] = useState(0)
  ...
  const panggilData1 = async () => {
    ...
    await fetch(base_url + '/accounting', option).then(res => res.json()).then(data1 => {
      setData1(data1.invocationResult);
      console.log(data.invocationResult);
    });
  }
